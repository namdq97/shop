...
function myFunction(){
       ...
       window.location.replace(`http://localhost:8000/admin/search-customer?name=${param}`);
}
</script>
            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return confirm('Do you want to delete?')" href="{{URL::to('admin/del-customer/')}}@php echo '/'.$item->id @endphp" class="active" ui-toggle-class="">    
