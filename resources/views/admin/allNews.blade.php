...
function myFunction(){
       ...
       window.location.replace(`http://localhost:8000/admin/search-news?name=${param}`);
}
</script>
            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::to('/admin/update-news')}}?id=@php echo $item->id @endphp" class="active" ui-toggle-class="">
                                <i class="fa fa-pencil text-success text-active"></i>
                            </a>
                        </td>
                        <td>
                            <a onclick="return confirm('Do you want to delete?')" href="{{URL::to('admin/del-news/')}}@php echo '/'.$item->id @endphp" class="active" ui-toggle-class="">    
