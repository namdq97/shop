            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="mySelect-{{$item->id}}" onchange="updateStt(<?php echo $item->id ?>)" name="status" class="form-control input -sm m-bot15">
                                @if($item->status === 0)
                        ...
                        <td>
                            <a onclick="return confirm('Do you want to delete?')" href="{{URL::to('admin/del-bill/')}}@php echo '/'.$item->id @endphp" class="active" ui-toggle-class="">    
